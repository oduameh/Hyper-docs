...
### Deploying and establishing mediation
...
### Establishing a connection on the holder side
...
## Issuing a credential from the issuer to the holder
...
### Accepting the credential offer invitation for connectionless issuance **Holder**
...
### Storing the issued credential \[Holder\]
...
## Requesting verification from the Verifier Cloud agent to the holder (JWT W3C Credential)
...
### Accepting the request presentation invitation for connectionless verification **Holder**
...
### Receiving the presentation proof request as the holder
...
### Checking the presentation request status as the verifier
