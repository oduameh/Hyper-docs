...
## Introducing credential schemas

## Summarizing the schema specification
...
## Detailing credential schema attributes

### Tracking the guid (UUID)
...
### Recording the id (UUID)

The locally unique identifier of the schema.

### Referencing the longId (string)
...
### Capturing the authored timestamp (DateTime)
...
### Structuring the schema (JSON Schema)
...
### Structuring the schema (AnonCred schema)
...
### Defining the JSON schema for the verifiable credential
...
### Creating the credential schema record
...
### Updating the credential schema
...
### Defining the updated JSON schema for the verifiable credential
...
### Updating the credential schema record
