...
## Understanding credential definitions
...
## Introducing the AnonCred credential definition

This section introduces the standard components of an AnonCred credential definition and explains how they apply within Hyperledger Identus.
...
## Explaining the AnonCred credential definition
...
## Detailing AnonCred credential definition attributes

### Setting the name (string)
...
### Selecting the signatureType (string)
...
### Enabling supportRevocation (boolean)
...
### Defining the credential definition for the verifiable credential
...
### Creating the credential definition record
...
### Retrieving the created credential definition
...
### Updating the credential definition
...
## Managing credential definition versions

When you change an existing credential definition, version the new entry accurately. Proper versioning ensures clarity and avoids conflicts among different iterations of the same definition.
...
## Understanding the connectionless issuance flow
...
## Reviewing the OID4VCI authorization code issuance example
...
## Understanding the proof presentation flow
...
## Managing verifier interactions
...
## Understanding the revocation payload
